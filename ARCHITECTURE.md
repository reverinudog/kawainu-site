...
| ナビゲーション | 38-231 | 固定ナビ、スクロール時ブラー、ドロップダウン（Achievements▾/Contents▾）、ハンバーガーメニュー（☰→×アニメーション） |
...
| Footer | 514-541 | フッター |
| レスポンシブ | 1775- | 768px（ハンバーガーメニュー化+アコーディオンDD）/ 480px ブレークポイント |
...
| ナビスクロール + ドロップダウン + ハンバーガー | 80px 超えで `.scrolled` 付与、ドロップダウン開閉、ハンバーガーメニュー開閉（body scroll lock、ESC/外部クリック対応） |
...
| `main.js` | ゲームロジック: 3Dシーン・物理演算・ダイス生成/投擲・結果判定・演出・モバイルカメラ調整 |
