...
- [ ] **Cloudflare Pages デプロイ** — サイト公開 + 訪問者カウンターAPI。Cloudflareアカウント作成 → GitHub連携 → KV設定
- [ ] **アバター画像の差し替え**
- [ ] **将来的: 独自ドメイン取得**
...
- [x] 訪問者カウンターUI追加（14桁レトロオドメーター、Cloudflare Workers + KV バックエンド、F5連打対策、ロールアニメーション、デモモード）
