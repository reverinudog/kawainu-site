...
- [x] ナビバー モバイルレイアウト修正（768px以下ハンバーガーメニュー化）
- [x] お祓いシミュレーター 広告導入（AdSense インタースティシャル、プレースホルダーID）
- [x] Contact セクション文言変更（「お気軽にご連絡ください」→「お問い合わせはこちらから」）
- [x] robots.txt + sitemap.xml 追加 + Worker エラーハンドリング修正（AdSense 審査対応）
